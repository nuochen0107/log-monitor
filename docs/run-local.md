...
6. 在分析任务区域查看任务状态、日志行数、异常数和处理耗时，点击“查看异常”筛选该批次异常。
7. 在异常事件区域按部署单元或异常类型筛选，点击“详情”查看异常模板、异常栈、分类分数和命中关键词。
8. 在异常详情中点击“查看 Trace 链路”，或在 Trace 链路定位区域输入 traceId，查看同一次请求的上下文日志和疑似根因。
9. 在告警中心查看默认告警规则和上传日志后生成的告警事件，可手动新增规则或关闭告警。
10. 在知识库区域新增或编辑处理方案，在异常详情中对推荐方案提交“有效”或“无效”反馈。
